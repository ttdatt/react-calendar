...
export declare type ViewType = 'years' | 'months' | 'month_dates';
...
declare type CommonProps = Required<Pick<CalendarProps, 'lockView' | 'isDisabled' | 'noPadRangeCell' | 'disableFuture' | 'disablePast' | 'disableToday' | 'weekends' | 'fixedRange' | 'startOfWeek' | 'skipDisabledDatesInRange' | 'allowFewerDatesThanRange' | 'fontSize' | 'size' | 'hideAdjacentDates' | 'useDarkMode' | 'showDualCalendar' | 'className'>> & Pick<CalendarProps, 'onEachMultiSelect' | 'onPartialRangeSelect' | 'onChange' | 'initialView'>;
...
export interface DayOfMonthSelectorProps extends Pick<CalendarViewProps, 'onChangenNewSelectedRangeEnd' | 'noPadRangeCell' | 'onChangenNewSelectedRangeStart' | 'startOfWeek' | 'fixedRange' | 'selectedDate' | 'selectedRangeStart' | 'selectedRangeEnd' | 'newSelectedRangeStart' | 'newSelectedRangeEnd' | 'isRangeSelectorView' | 'isFixedRangeView' | 'weekends' | 'selectedMultiDates' | 'isMultiSelectorView' | 'isRangeSelectModeOn' | 'onChangeRangeSelectMode' | 'disableFuture' | 'disablePast' | 'disableToday' | 'hideAdjacentDates' | 'lockView' | 'highlightsMap' | 'isDisabled' | 'checkIfWeekend' | 'onChange' | 'onPartialRangeSelect' | 'onEachMultiSelect' | 'maxAllowedDate' | 'minAllowedDate' | 'allowFewerDatesThanRange' | 'skipDisabledDatesInRange'> {
    monthInView: MonthIndices;
    yearInView: number;
}
